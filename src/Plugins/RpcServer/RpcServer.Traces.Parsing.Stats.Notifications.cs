...
//
// RpcServer.Traces.Parsing.Stats.Notifications.cs file belongs to the neo project and is free
...
namespace Neo.Plugins.RpcServer
{
    ...
    {
        private static NotificationStatsQueryOptions ParseNotificationStatsOptions(JToken? token)
        {
            var options = new NotificationStatsQueryOptions();
            ...
            if (obj.ContainsProperty("eventName"))
            {
                var name = obj["eventName"]?.AsString();
