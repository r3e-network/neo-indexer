...
//
// RpcServer.Traces.Parsing.Stats.RuntimeLogs.cs file belongs to the neo project and is free
...
namespace Neo.Plugins.RpcServer
{
    ...
    {
        private static RuntimeLogStatsQueryOptions ParseRuntimeLogStatsOptions(JToken? token)
        {
            var options = new RuntimeLogStatsQueryOptions();
