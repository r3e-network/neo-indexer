...
//
// RpcServer.Traces.Parsing.Stats.StorageReads.cs file belongs to the neo project and is free
...
namespace Neo.Plugins.RpcServer
{
    ...
    {
        private static StorageReadStatsQueryOptions ParseStorageReadStatsOptions(JToken? token)
        {
            var options = new StorageReadStatsQueryOptions();
            ...
            if (obj.ContainsProperty("source"))
            {
                var source = obj["source"]?.AsString();
