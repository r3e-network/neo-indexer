...
//
// StateRecorderSupabase.PostgresUpload.BlockState.StorageReads.cs file belongs to the neo project and is free
...
namespace Neo.Persistence
{
    public static partial class StateRecorderSupabase
    {
        ...
        private static async Task UpsertStorageReadsPostgresAsync(
            NpgsqlConnection connection,
            NpgsqlTransaction transaction,
        ...
        private static async Task InsertStorageReadsPostgresAsync(
            NpgsqlConnection connection,
            NpgsqlTransaction transaction,
            List<StorageReadRecord> reads)
        {
