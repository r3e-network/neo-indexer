...
- Captures traces at VM/diagnostic level: opcode execution, syscalls, contract calls, storage writes (before/after + explicit delete flag), notifications, runtime logs (`System.Runtime.Log`).
