-- Migration: 029_partition_management_runtime_logs.sql
-- Description: Extend trace partition management allow-lists to include runtime_logs.
-- Date: 2025-12-15
--
-- The runtime_logs trace table is created in:
-- - migrations/019_runtime_logs.sql
--
-- This migration updates the SECURITY DEFINER partition management functions so
-- automated partition creation/pruning can manage runtime_logs partitions too.
...
-- Keep privileges aligned with earlier migrations (idempotent).
